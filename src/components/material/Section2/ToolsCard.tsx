        ...
        {herramientas && herramientas.length > 0 ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            {herramientas.map((item, i) => (
              ...
              >
                {/* Icono decorativo */}
                <div className="w-10 h-10 shrink-0 rounded-xl bg-teal-50 border border-teal-100 flex items-center justify-center text-red-400 group-hover:scale-110 transition-transform">
