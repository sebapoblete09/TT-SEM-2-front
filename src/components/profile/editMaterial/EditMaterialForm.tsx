...
export default function EditMaterialForm({
  ...
  if (success) {
    return (
      <div className="flex justify-center py-4 sm:py-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <Card className="w-full max-w-md p-4 sm:p-8 shadow-xl border bg-white text-center relative overflow-hidden rounded-2xl">
          <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-green-400 to-teal-500" />
          <div className="flex flex-col items-center">
            <div className="h-16 w-16 sm:h-20 sm:w-20 bg-green-100 rounded-full flex items-center justify-center mb-6">
          ...
          <div className="flex flex-col w-full">
            <Tabs defaultValue="general" className="w-full">
              ...
              <div className="p-4 sm:p-6 bg-slate-50/30 min-h-[300px]">
                ...
                <TabsContent value="propiedades" className="mt-0 space-y-4">
                  <PropertiesSection />
                </TabsContent>

                <TabsContent value="proceso" className="mt-0 space-y-4">
                  <StepsSection />
                </TabsContent>

                <TabsContent value="galeria" className="mt-0 space-y-4">
                  <GallerySection />
                </TabsContent>
              </div>
            </Tabs>

            <div className="bg-slate-50 px-4 sm:px-6 py-4 border-t flex justify-end gap-4 sticky bottom-0 z-10">
              <Button
                type="submit"
                disabled={loading}
                size="lg"
